...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "/Upload/finder/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath("~/Upload/finder/");
        ...
        //// Thumbnail settings. küçük resim ayarý
        ...
        //Thumbnails.Url = BaseUrl + "/finder/";
        //if (BaseDir != "")
        //{
        //    Thumbnails.Dir = BaseDir + "/finder/";
        //}
